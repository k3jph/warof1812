...
import { chapterBySlug, chapters, events, sourceById } from "@/lib/content";
...
export default async function ChapterPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const documentaryPacket = documentaryByChapter[chapter.slug];
  return (
