...
export const metadata: Metadata = { title: "Follow the War", description: "Move through a coordinate-backed map of the War of 1812 and open every event in the connected narrative." };
