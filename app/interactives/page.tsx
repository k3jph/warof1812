...
const systems = [
  ...
  ["05","The human record","Search hundreds of named people; inspect shared events, units, places, ties, identity confidence, and archival survival.","People · power · evidence","/people"],
] as const;
