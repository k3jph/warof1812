...
export const metadata: Metadata = pageMetadata("/people", "People", "Twenty-four curated person dossiers and a larger research index of names connected to the War of 1812.");
