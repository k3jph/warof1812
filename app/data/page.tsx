...
export const metadata: Metadata = pageMetadata("/data", "Open Data", "Download the public event, timeline, people, and source records behind 1812: The Whole Story.");
...
const downloads = [
  ...
  { href: "/data/historical-gis.geojson", title: "Campaign map GIS data", count: gisFeatures.length, description: "Dated campaign lines, operational zones, homeland regions, freedom-seeking routes, logistics, historical geography, and surviving-site points, with uncertainty and provenance." },
