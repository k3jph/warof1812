...
export const warClockEntries: ClockEntry[] = [
  ...
  { id:"fort-jackson", date:"1814-08-09", layer:"diplomatic", place:"Alabama Territory", title:"Treaty of Fort Jackson imposed", summary:"A vast Muscogee land cession includes territory claimed by U.S. allies as well as opponents.", sourceRefs:["nps-creek"], href:"/events/treaty-fort-jackson" },
  ...
  { id:"key-print", date:"1814-09-20", layer:"newspaper", place:"Baltimore", title:"Key’s lyric circulates in print", summary:"A witnessed bombardment becomes a reproducible public text within days.", sourceRefs:["nps-bombardment"], href:"/explore/documents/defence-fort-mhenry" },
