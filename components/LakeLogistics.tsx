...
const baseValues: Record<Resource,number> = { timber:72, iron:54, guns:48, canvas:56, "skilled labor":62, sailors:58, food:66, transport:45 };

export function LakeLogistics() {
  const [baseId, setBaseId] = useState("sackets");
